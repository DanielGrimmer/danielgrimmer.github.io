...
export const escherChessMoves8x8 = {
    pawn: {
        white: {
            moves: [
        ...
        black: {
            moves: [
                ...
                {move: [0, -2], jumpy: false, reqCapture: false, initialOnly: true},
                // Capture moves diagonally
                {move: [3, -1], jumpy: true, reqCapture: true},
                {move: [-3, -1], jumpy: true, reqCapture: true}
            ]
        }
    },
    ...
    king: {
        ...
        black: {
            moves: [
                ...
                {move: [0, 1], jumpy: false, reqCapture: false},
                {move: [0, -1], jumpy: false, reqCapture: false},
                {move: [3, 0], jumpy: true, reqCapture: false}, // Horizontal moves are jumpy
                {move: [-3, 0], jumpy: true, reqCapture: false}, // Horizontal moves are jumpy
                {move: [3, 1], jumpy: true, reqCapture: false},
                {move: [3, -1], jumpy: true, reqCapture: false},
                {move: [-3, 1], jumpy: true, reqCapture: false},
...
export const INITIAL_BOARD_CONFIG_8x8_ESCHER = [
    // White pieces
    ...
    { type: PIECE_TYPES.BLACK_BISHOP, row: 7, col: 1 },
    { type: PIECE_TYPES.BLACK_BISHOP, row: 7, col: 2 },
    { type: PIECE_TYPES.BLACK_ROOK, row: 7, col: 3 },
    { type: PIECE_TYPES.BLACK_KING, row: 7, col: 4 },
    { type: PIECE_TYPES.BLACK_KNIGHT, row: 7, col: 5 },
    { type: PIECE_TYPES.BLACK_KNIGHT, row: 7, col: 6 },
    { type: PIECE_TYPES.BLACK_QUEEN, row: 7, col: 7 },
