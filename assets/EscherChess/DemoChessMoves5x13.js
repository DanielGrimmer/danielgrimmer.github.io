...
export const demoChessMoves5x13 = {
    pawn: {
        white: {
            moves: [
...
export const INITIAL_BOARD_CONFIG_5x13 = [
    ...
    { type: PIECE_TYPES.BLACK_BISHOP, row: 12, col: 0 },
    { type: PIECE_TYPES.BLACK_ROOK, row: 12, col: 1 },
    { type: PIECE_TYPES.BLACK_KING, row: 12, col: 2 },
    ...
    { type: PIECE_TYPES.BLACK_KNIGHT, row: 11, col: 1 },
    { type: PIECE_TYPES.BLACK_PAWN, row: 11, col: 2 },
