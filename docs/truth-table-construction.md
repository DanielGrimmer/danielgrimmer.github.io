...
2. Twelve negation-and-scope problems on four comparison pages: conditional,
   conjunction, disjunction, biconditional. Each page compares negating the
   left letter, the whole formula, and the right letter, with separate answers
   and a short optional calculation explanation.
...
There are 35 numbered formulas across 27 pages. Each formula displays
“Problem N of 35.” Previous/Next navigate pages, keeping each trio together;
individual links select the requested formula within its comparison page.
