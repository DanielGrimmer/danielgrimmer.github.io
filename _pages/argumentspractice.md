...
<!--
  ...
  _pages/arguments.md. Shares assets/logic/encyclopedia.{css,js} with the
  catalogue and adds assets/logic/practice.js for the draw.
...
<script type="module" src="{{ '/assets/logic/practice.js' | relative_url }}"></script>
