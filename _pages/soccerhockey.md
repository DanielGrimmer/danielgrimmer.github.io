...
<script type="module">
   ...
   */
  import { SOCCER_HOCKEY } from '{{ "/assets/games/core/presets.js" | relative_url }}?v=4.27.0';
  import { initialGame, viewOf, squareFromView } from '{{ "/assets/games/core/game.js" | relative_url }}?v=4.27.0';
  import { createBoardView } from '{{ "/assets/games/ui/board.js" | relative_url }}?v=4.27.0';
