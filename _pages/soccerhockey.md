...
<link rel="stylesheet" href="{{ '/assets/games/ui/board.css' | relative_url }}?v=4.21.0" />
<link rel="stylesheet" href="{{ '/assets/games/ui/pages.css' | relative_url }}?v=4.21.0" />
...
<script type="module">
   ...
   */
  import { SOCCER_HOCKEY } from '{{ "/assets/games/core/presets.js" | relative_url }}?v=4.21.0';
  import { initialGame, viewOf, squareFromView } from '{{ "/assets/games/core/game.js" | relative_url }}?v=4.21.0';
  import { createBoardView } from '{{ "/assets/games/ui/board.js" | relative_url }}?v=4.21.0';
